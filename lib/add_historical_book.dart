...
class add_historical_book extends StatefulWidget {
  const add_historical_book({super.key});

  @override
  State<add_historical_book> createState() => _add_historical_bookState();
}

class _add_historical_bookState extends State<add_historical_book> {
  ...
  void _CreateBookInfo() async {
    ...
    if (bookName_ == "" ||
      ...
      FirebaseFirestore.instance.collection("Historical").add(NewBookData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Historical Book Add"),
